...
var _parentNode = __webpack_require__(74);
...
var Search = function (_Component) {
	...
	function Search(props) {
		...
		_this.resetActivity = _this.resetActivity.bind(_this);
		return _this;
	}
	...
	_createClass(Search, [{
		...
		value: function resetActivity() {
			var _state = this.state,
			    ...
			    child = _state.child,
			    parent_new = _state.parent_new,
			    child_new = _state.child_new;
		...
		value: function render() {
			var _state2 = this.state,
			    data = _state2.data,
			    parent_new = _state2.parent_new,
			    child_new = _state2.child_new,
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'text', value: data,
					...
					_react2.default.createElement(
						'button',
						{ type: 'reset', onClick: this.resetActivity },
						'Reset'
					)
				),
				_react2.default.createElement(
				...
				_react2.default.createElement(_parentNode2.default, { parent: parent_new, child: child_new })
			);
		}
	}]);
...
var _SortableElement2 = __webpack_require__(184);

var _SortableElement3 = _interopRequireDefault(_SortableElement2);

var _SortableHandle2 = __webpack_require__(185);
...
_reactDom2.default.render(_react2.default.createElement(_search2.default, null), document.querySelector('.container'));
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(6),n=__webpack_require__(14),p=__webpack_require__(4);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(37),A=__webpack_require__(6),B=__webpack_require__(4),ca=__webpack_require__(38),da=__webpack_require__(39),ea=__webpack_require__(40),ha=__webpack_require__(41),ia=__webpack_require__(42),C=__webpack_require__(14);
...
var _reactSortableHoc = __webpack_require__(44);

var _childNode = __webpack_require__(186);
...
var SortableItem = (0, _reactSortableHoc.SortableElement)(function (props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_childNode2.default, { child: child })
  );
});
...
var SortableList = (0, _reactSortableHoc.SortableContainer)(function (props) {
  ...
  return _react2.default.createElement(
    ...
    items.map(function (value, index) {
      return _react2.default.createElement(SortableItem, { key: 'item-' + index, index: index, value: value, child: child[index], classVal: classVal });
    })
  );
});

var ParentNode = function (_Component) {
  _inherits(ParentNode, _Component);

  function ParentNode(props) {
    _classCallCheck(this, ParentNode);

    var _this = _possibleConstructorReturn(this, (ParentNode.__proto__ || Object.getPrototypeOf(ParentNode)).call(this, props));
    ...
    _this.onSortEnd = function (_ref) {
      ...
      _this.setState({
        parent: (0, _reactSortableHoc.arrayMove)(_this.state.parent, oldIndex, newIndex),
        child: (0, _reactSortableHoc.arrayMove)(_this.state.child, oldIndex, newIndex)
      });
    };
  ...
  _createClass(ParentNode, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(SortableList, { items: this.state.parent, onSortEnd: this.onSortEnd, child: this.state.child, classVal: this.state.class })
      );
    }
  }]);
...
var _Manager = __webpack_require__(78);
...
var _sortBy = __webpack_require__(162);
...
var arrayMap = __webpack_require__(61),
    ...
    baseUnary = __webpack_require__(56),
    compareMultiple = __webpack_require__(173),
    identity = __webpack_require__(24);
...
var compareAscending = __webpack_require__(174);
...
var ChildNode = function (_Component) {
  _inherits(ChildNode, _Component);

  function ChildNode(props) {
    _classCallCheck(this, ChildNode);

    var _this = _possibleConstructorReturn(this, (ChildNode.__proto__ || Object.getPrototypeOf(ChildNode)).call(this, props));
    ...
    _this.state = { items: props.child, childClass: props.childClass };
    return _this;
  }
  ...
  _createClass(ChildNode, [{
    ...
    value: function render() {
      var _state = this.state,
          items = _state.items,
          childClass = _state.childClass;

      return _react2.default.createElement(
        'div',
        { className: 'childNode' },
        _react2.default.createElement(SortableList, { items: items, onSortEnd: this.onSortEnd })
      );
    }
  }]);
